package mx.edu.tesoem.isc.tlgr.sensormovimiento;
...
public class MainActivity extends AppCompatActivity {
    ...
    aleatorio i1 = new aleatorio(R.drawable.uno,    "River", R.raw.sound1);
    aleatorio i2 = new aleatorio(R.drawable.dos,    "插曲 非同小可", R.raw.sound2);
    aleatorio i3 = new aleatorio(R.drawable.tres,   "Say Something", R.raw.sound3);
    aleatorio i4 = new aleatorio(R.drawable.cuatro, "我非常喜欢你，你会知道的", R.raw.sound4);
    aleatorio i5 = new aleatorio(R.drawable.cinco,  "无名之辈", R.raw.sound5);
    aleatorio i6 = new aleatorio(R.drawable.seis,   "Hades", R.raw.sound6);
    aleatorio i7 = new aleatorio(R.drawable.siete,  "Miss Me", R.raw.sound7);
